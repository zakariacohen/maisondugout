...
export const OrderForm = ({ onAddOrder }: OrderFormProps) => {
  ...
  const [items, setItems] = useState<OrderItem[]>([
    { product: "", quantity: 1, unitPrice: 0, total: 0 },
  ]);
    ...
    <Card className="shadow-lg border-border/50">
      <CardHeader className="bg-gradient-to-r from-primary/5 to-accent/5">
        <div className="flex items-center gap-2">
          ...
          <div>
            <CardTitle className="text-xl font-serif">Nouvelle Commande</CardTitle>
            <CardDescription>Ajoutez les détails de la commande</CardDescription>
          </div>
        </div>
      </CardHeader>
